...
<ul class="uk-list">
    ...
    <li>
        ...
        <div class="uk-flex">
            <div class="uk-width-1-2"><span><?= $post['plate']['name'] ?></span><span class="uk-margin-small-left"><?= date("Y-m-d",$post['create_at'])?></span></div>
            <div class="uk-width-1-2 uk-text-right"><span uk-icon="icon: video-camera;ratio: 0.8"></span><?= $post['view'] ?><span class="uk-margin-min-left" uk-icon="icon: commenting;ratio: 0.8"></span><?= $post['comments'] ?></div>
        </div>
    </li>
