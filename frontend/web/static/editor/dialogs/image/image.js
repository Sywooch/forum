...
//                }
    ...
    var Upload = {
        ...
        uploadTpl: '<div class="edui-image-upload%%">' +
            ...
            '<input style=\"filter: alpha(opacity=0);\" class="edui-image-file" type="file" hidefocus name="ImageForm[imageFile]" accept="image/gif,image/jpeg,image/png,image/jpg,image/bmp"/>' +
            '<input type="hidden" name="_csrf" value="'+csrfs+'"/>' +
        ...
        submit: function (callback) {
            ...
            var me = this,
                input = $( '<input style="filter: alpha(opacity=0);" class="edui-image-file" type="file" hidefocus="" name="ImageForm[imageFile]" accept="image/gif,image/jpeg,image/png,image/jpg,image/bmp">'),
                input = input[0];
