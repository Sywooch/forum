...
<form class="layui-form">
            ...
            <div class="layui-input-block">
                <select name="PlateForm[fid]">
                    ...
                    <?php foreach($plates as $plate){ ?>
                        <option value="<?= $plate['id'] ?>"   <?php if($info['fid']==$plate['id']){ ?> selected=""  <?php } ?>  ><?= $plate['name'] ?></option>
                    <?php } ?>
                </select>
            </div>
        </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="PlateForm[name]" lay-verify="required|name" autocomplete="off" value="<?= $info['name'] ?>" placeholder="请输入版区名" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">版区简介</label>
        <div class="layui-input-block">
            <input type="text" name="PlateForm[intro]" lay-verify="required|intro" autocomplete="off" value="<?= $info['intro'] ?>" placeholder="请输入版区简介" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="radio" name="PlateForm[recommend]" value="2" title="推荐" <?php if($info['is_recommend']==2){ ?> checked=""  <?php } ?> >
            <input type="radio" name="PlateForm[recommend]" value="1" title="不推荐" <?php if($info['is_recommend']==1){ ?> checked=""  <?php } ?>>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
