...
<form class="layui-form" action="">
    ...
    <input type="hidden" name="AccountForm[id]" value="<?= $info['id'] ?>" readonly/>
        ...
        <div class="layui-input-block">
            <select name="AccountForm[role]" lay-verify="required">
                ...
                <?php foreach($lists as $list){ ?>
                    <option value="<?= $list['name'] ?>"  <?php if($info['role']==$list['name']){ ?> selected="" <?php } ?> ><?= $list['description'] ?></option>
                <?php } ?>
            </select>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="AccountForm[username]" lay-verify="required|username" autocomplete="off" value="<?= $info['username'] ?>" placeholder="请输入用户名" class="layui-input" readonly>
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">密码</label>
        <div class="layui-input-block">
            <input type="password" name="AccountForm[password]" lay-verify="required|password" autocomplete="off" value="" placeholder="请输入密码" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
