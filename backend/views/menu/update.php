...
<form class="layui-form" action="">
    ...
    <input type="hidden" name="MenuForm[id]" value="<?= $info['id'] ?>" readonly/>
        ...
        <div class="layui-input-block">
            <select name="MenuForm[pid]" lay-verify="required">
                ...
                <?php foreach($lists as $list){ ?>
                    <option value="<?= $list['id'] ?>" <?php if($info['pid']==$list['id']){ ?> selected="" <?php } ?> ><?= $list['menu_name'] ?></option>
                <?php } ?>
            </select>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="MenuForm[menu_name]" lay-verify="required|menu_name" autocomplete="off" placeholder="请输入菜单名" value="<?= $info['menu_name'] ?>" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">菜单链接</label>
        <div class="layui-input-block">
            <input type="text" name="MenuForm[menu_url]" lay-verify="required|menu_url" autocomplete="off" placeholder="请输入菜单链接" value="<?= $info['menu_url'] ?>" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
